...
def get_processed_data():
    ...
    new_test_path = r'补充实验2\new_test_dataset.csv'
    new_test_df = pd.read_csv(new_test_path)
    
    # 读取test1_new_dataset.csv
    test1_path = r'补充实验2\test1_new_dataset.csv'
...
def get_formula_upper_bound():
    results_file = r'补充实验2\tvd_results.txt'
...
def main():
    ...
    # 保存结果到CSV文件
    results_file = r'补充实验2\prediction_rmse_results.csv'
    ...
    # 保存图表
    output_path = r'补充实验2\sample_error_comparison2.png'
