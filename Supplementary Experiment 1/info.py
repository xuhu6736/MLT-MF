...
# 定义结果文件路径
results_file_path = r'补充实验\tvd_results.txt'
...
with open(results_file_path, 'w', encoding='utf-8') as results_file:
    ...
    try:
        ...
        if not uncovered_df.empty:
            ...
            if not uncovered_df.empty:
                # 读取网格信息文件
                new_test_grid_path = r'补充实验\points_with_grid_info\new_test_points_with_grid_info.csv'
                test1_grid_path = r'补充实验\points_with_grid_info\test1_points_with_grid_info.csv'
